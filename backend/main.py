...
try:
    ...
    from backend.app.models.detection import DetectionLog, DetectionRequest, DetectionResponse
    ...
    try:
        ...
        for file in files:
            try:
                ...
                result["predicted_class"] = str(result.get("predicted_class", "unknown"))
                ...
                result["model_status"] = str(result.get("model_status", "")) if result.get("model_status") else None
