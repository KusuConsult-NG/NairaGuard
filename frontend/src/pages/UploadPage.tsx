...
const UploadPage: React.FC = () => {
              ...
              ? {
                  ...
                  result: {
                    ...
                    details: isFake
                      ? [
                          'Watermark mismatch',
                          'Security thread anomaly',
                          'Color variation detected',
                        ]
                      : [
                          'All security features verified',
                          'Watermark authentic',
                          'Security thread intact',
                        ],
                  },
                }
              : f
  ...
  const getStatusIcon = (status: UploadedFile['status']) => {
    switch (status) {
      case 'processing':
        return (
          <div className="w-4 h-4 border-2 border-naira-600 border-t-transparent rounded-full animate-spin" />
        );
      case 'completed':
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Drag and drop your images or click to browse. We support JPG, PNG,
        ...
        {files.length > 0 && (
          <div className="mt-8">
            ...
            <div className="space-y-4">
              {files.map(file => (
                <div key={file.id} className={`card ${getStatusColor(file)}`}>
